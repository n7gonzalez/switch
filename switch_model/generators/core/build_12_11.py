...
def define_components(mod):
    ...
    mod.co2_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals, default=0)
...
def load_inputs(mod, switch_data, inputs_dir):
    ...
    switch_data.load_aug(
        ...
        param=(mod.gen_dbid, mod.gen_tech, mod.gen_energy_source,
               ...
               mod.gen_is_distributed, mod.gen_dispatch_minimum,mod.co2_load_zone_intensity))
