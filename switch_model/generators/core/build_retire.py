...
def define_components(mod):
    ...
    #mod.GENERATION_PROJECTS_emission = Set()
    mod.CO2_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    mod.SO2_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    mod.NOx_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    mod.PM25_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    mod.CO_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    mod.PM10_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    mod.PMcoarse_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    mod.VOC_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals)
    ...
    """
    mod.gen_energy_source_RPS = Param(mod.GENERATION_PROJECTS, 
        validate=lambda m,val,g: val in m.ENERGY_SOURCES_RPS or val == "multiple")       
    mod.gen_uses_fuel_RPS = Param(
        mod.GENERATION_PROJECTS,
        initialize=lambda m, g:  
            m.gen_energy_source_RPS[g] )
...
def load_inputs(mod, switch_data, inputs_dir):
    ...
    switch_data.load_aug(
        filename=os.path.join(inputs_dir, 'emission_by_province.tab'),
        auto_select=True,
        optional_params=['CO2_load_zone_intensity','SO2_load_zone_intensity','NOx_load_zone_intensity','PM25_load_zone_intensity',
        'CO_load_zone_intensity','PM10_load_zone_intensity','PMcoarse_load_zone_intensity','VOC_load_zone_intensity'],
        index=mod.GENERATION_PROJECTS,
        param=(mod.CO2_load_zone_intensity,mod.SO2_load_zone_intensity,
               mod.NOx_load_zone_intensity,mod.PM25_load_zone_intensity,mod.CO_load_zone_intensity,
               mod.PM10_load_zone_intensity,mod.PMcoarse_load_zone_intensity,mod.VOC_load_zone_intensity))
    ...
    #new input for retire
    switch_data.load_aug(
        optional=True,
        filename=os.path.join(inputs_dir, 'gen_build_predetermined_retire.tab'),
        auto_select=True,
        optional_params=['gen_can_retire_early'],
        index=mod.PREDETERMINED_GEN_BLD_YRS,
        #param=(mod.gen_predetermined_cap))
        param=(mod.gen_can_retire_early))
