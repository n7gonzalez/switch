...
def define_components(mod):
    ...
    mod.SO2_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals, default=0)
    mod.NOx_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals, default=0)
    mod.PM25_load_zone_intensity = Param(mod.GENERATION_PROJECTS, within=NonNegativeReals, default=0)
...
def load_inputs(mod, switch_data, inputs_dir):
    ...
    switch_data.load_aug(
        ...
        'co2_load_zone_intensity','SO2_load_zone_intensity','NOx_load_zone_intensity','PM25_load_zone_intensity'],
        ...
        param=(mod.gen_dbid, mod.gen_tech, mod.gen_energy_source,
               ...
               mod.co2_load_zone_intensity,mod.SO2_load_zone_intensity,
               mod.NOx_load_zone_intensity,mod.PM25_load_zone_intensity))
